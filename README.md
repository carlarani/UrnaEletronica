# Exercício 01 - Testes Unitários
Crie um novo projeto do tipo ClassLibrary, utilizando o framework .Net de sua preferência, onde será construído 
um sistema de urna eletrônica.
...
## Nos testes, utilize [Fact] ou [Theory] onde julgar necessário. Ao terminar, suba o fonte no seu próprio Github e envie o link no canal #temp-testes-unitarios-exerc01 no Discord. Serão consideradas as entregas realizadas até o dia 29/09 às 23:59.